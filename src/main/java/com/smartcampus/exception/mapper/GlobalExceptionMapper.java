...
/**
 * Part 5.4 - Global catch-all mapper. Catches unexpected errors and returns
 * 500. Lets JAX-RS WebApplicationExceptions (404, 405 etc) pass through
 * normally.
 */
@Provider
public class GlobalExceptionMapper implements ExceptionMapper<Throwable> {
    ...
    public Response toResponse(Throwable ex) {
        ...
        LOG.severe(() -> "Unexpected error: " + ex.getClass().getName() + " - " + (ex.getMessage() != null ? ex.getMessage() : "No message"));
